...
<body>
    ...
    <!-- ===== HERO ===== -->
<section class="hero position-relative overflow-hidden" style="min-height: 60vh;">
    ...
    <div class="container position-relative h-100 d-flex align-items-center justify-content-center" style="z-index: 2; min-height: 60vh;">
